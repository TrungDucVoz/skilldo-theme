<?php
class widget_about_style_2 extends widget {
    function __construct() {
        parent::__construct('widget_about_style_2', 'About (style 2)', [ 'container' => true, 'position' => 'right' ]);
    ...
    function form($left = [], $right = []) {
        ...
        $left[] = ['field' => 'item', 'type' => 'widget_about_style_2::inputItem', 'arg' => ['number' => 3]];
    ...
    function widget() {
        $box = $this->container_box('widget_about_style_2');
        echo $box['before']; ?>
        <div class="row">
            <div class="<?php echo $this->options->position;?> col-md-6 about-image"><?php Template::img($this->options->banner_img, $this->name, ['lazy' => 'default']);?></div>
    ...
    function css() { include_once('assets/about-style-2.css'); }
    ...
    function default() {
        if($this->name == 'About (style 2)') $this->name = 'How We Can Help You Achieve Your Business Goal';
    ...
    static public function inputItem($param, $value = []) {
        ...
        $value_default = array( 'image' => '', 'title' => '', 'animate' => '', 'description' => '' );
        //Số Lượng item
...
Widget::add('widget_about_style_2');