...
class widget_item_style_3 extends widget {
    ...
    function form( $left = [], $right = []) {
        ...
        $right[] = ['field' => 'perMobile', 'label' =>'Số item/hàng (Mobile)', 'type' => 'col', 'value' => 2, 'args' => ['min'=>1, 'max' => 2]];
    ...
    function widget() {
        ...
        <div class="row-flex">
            ...
            <div class="item item<?php echo $key;?>" data-aos-delay="<?php echo $number++*300;?>" data-aos="<?php echo $item['animate'];?>" data-aos-duration="2000">
