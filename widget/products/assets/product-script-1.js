$(function () {
    ...
    function product_style_1_slider(id, options) {
        ...
        let productList     = $('#product_style_1_content_' + id + ' .list-product');
        ...
        $('#product_style_1_content_'+ id).attr('data-run', true);
    }
    function product_style_1_slider_load(categoryId, widgetId, options) {
        ...
        let runSlick = $('#product_style_1_content_'+ widgetId).attr('data-run');
