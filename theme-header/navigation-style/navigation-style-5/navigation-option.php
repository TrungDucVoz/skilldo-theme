...
ThemeOption::addField('nav','nav_vh_text2', 'text', ['sub' => 'nav_vh_header', 'label' => 'Tiêu đề', 'after' => '<div class="col-md-3"><div class="form-group group">', 'before' => '</div></div>']);
ThemeOption::addField('nav','nav_vh_text2_color','color', ['sub' => 'nav_vh_header', 'label' => 'Màu chử tiêu đề', 'after' => '<div class="col-md-3"><div class="form-group group">', 'before' => '</div></div>']);
ThemeOption::addField('nav','nav_vh_bg2','color', ['sub' => 'nav_vh_header', 'label' => 'Màu nền tiêu đề', 'after' => '<div class="col-md-6"><div class="form-group group">', 'before' => '</div></div>']);
