<?php
Class ThemeNavigationStyle2 {

    public static $path = 'theme-header/navigation-style/navigation-style-2/';
...
if(!Admin::is()) {
    add_action('cle_header_navigation', 'ThemeNavigationStyle2::render');
    add_action('theme_custom_css_no_tag', 'ThemeNavigationStyle2::css');
    add_action('theme_custom_script_no_tag', 'ThemeNavigationStyle2::script');
}
else {
    add_action('theme_option_setup', 'ThemeNavigationStyle2::options', 20);
    add_action('init', 'ThemeNavigationStyle2::location');
    add_action('init', 'ThemeNavigationStyle2::sidebar');
}
