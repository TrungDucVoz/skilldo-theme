<?php $nav_skew = (option::get('nav_skew')) ? (int)option::get('nav_skew') : 35; ?>
<style>
    :root {
        --nav-skew:skewX(<?php echo (option::get('nav_skew_type') == 'right') ? $nav_skew : -$nav_skew;?>deg);
        --nav-skew2:skewX(<?php echo (option::get('nav_skew_type') == 'right') ? -$nav_skew : $nav_skew;?>deg);
        ...
        --nav-bg-img:url('<?php echo empty(option::get('nav_bg_img')) ? '' : option::get('nav_bg_img');?>');
        --nav-item-bg-color:<?php echo empty(option::get('nav_item_bg_color')) ? option::get('theme_color') : option::get('nav_item_bg_color') ;?>;
    ...
    .navigation .navbar-nav>li {
        ...
        transform: var(--nav-skew);
    }

    .navigation .navbar-nav>li>a {
        padding:var(--nav-padding);
        transform: var(--nav-skew2);
    }
