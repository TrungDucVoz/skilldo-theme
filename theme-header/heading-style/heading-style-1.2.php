<?php
Class ThemeHeadingStyle1_2 {
    static public function register($heading) {
        $heading['heading-style-1-2'] = ['label' => 'Heading Style 1.2', 'class' => 'ThemeHeadingStyle1_2'];
        return $heading;
    }
    static public function html($name, $options) {
        ?>
        <div class="header-title header-title-style-1-2">
    ...
    static public function css($options, $id = '') {
        ...
        ?>
        <style>
            body <?php echo $id;?> .header-title.header-title-style-1-2 {
                text-align: <?php echo $txtPosition;?>;
                margin: <?php echo $marginTop;?>px 0 <?php echo $marginBottom;?>px 0;
            }
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header-text-top {
            ...
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header-text-top:after {
                position: absolute;
                content: '';
                right: 0;
                top: 13px;
            ...
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header-image-bottom {
                margin-top: <?php echo $marginBottom;?>px; text-align: <?php echo $txtPosition;?>;
            }
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header-image-bottom img {
                display: inline-block;
            }
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header {
                text-align: <?php echo $txtPosition;?>;
            ...
            body <?php echo $id;?> .header-title.header-title-style-1-2 .header-description {
...
add_filter('theme_widget_heading', 'ThemeHeadingStyle1_2::register');
add_filter('theme_sidebar_heading', 'ThemeHeadingStyle1_2::register');
