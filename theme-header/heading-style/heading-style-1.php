<?php
Class ThemeHeadingStyle1 {
    static public function register($heading) {
        $heading['heading-style-1'] = ['label' => 'Heading Style 1', 'class' => 'ThemeHeadingStyle1'];
        return $heading;
    }
    ...
    static public function css($options, $id = '') {
        ...
        ?>
        <style>
            body <?php echo $id;?> .header-title.header-title-style-1 {
                text-align: <?php echo $txtPosition;?>;
                margin: <?php echo $marginTop;?>px 0 <?php echo $marginBottom;?>px 0;
            }
            body <?php echo $id;?> .header-title.header-title-style-1 .header-text-top {
                margin-bottom: <?php echo $txtTopMargin;?>px;
                color: <?php echo $txtTopColor;?>; font-size:<?php echo $txtTopFontSize;?>px;
            }
            body <?php echo $id;?> .header-title.header-title-style-1 .header-image-bottom {
                margin-top: <?php echo $marginBottom;?>px; text-align: <?php echo $txtPosition;?>;
            }
            body <?php echo $id;?> .header-title.header-title-style-1 .header-image-bottom img {
                display: inline-block;
            }
            body <?php echo $id;?> .header-title.header-title-style-1 .header {
                text-align: <?php echo $txtPosition;?>;
            ...
            body <?php echo $id;?> .header-title.header-title-style-1 .header-description {
    ...
    static public function form() {
        ...
        $Form = [
            ...
            ['name' => 'txtTopMargin', 'type' => 'number', 'label' => 'Cách heading', 'after' => '<div class="builder-col-6 col-md-4 form-group group">', 'before'=> '</div>'],
            ...
            ['name' => 'txtPosition', 'type' => 'tab', 'label' => 'Vị trí', 'options' => ['left' => 'Trái', 'center' => 'Giữa', 'right' => 'Phải'], 'after' => '<div class="col-md-12 form-group group">', 'before'=> '</div>', 'value' => 'center'],
            ['name' => 'txtColor', 'type' => 'color', 'label' => 'Màu tiêu đề', 'after' => '<div class="col-md-4 form-group group">', 'before'=> '</div>'],
            ['name' => 'marginTop', 'type' => 'number', 'label' => 'Cách trên', 'after' => '<div class="builder-col-6 col-md-4 form-group group">', 'before'=> '</div>'],
            ['name' => 'marginBottom', 'type' => 'number', 'label' => 'Cách dưới', 'after' => '<div class="builder-col-6 col-md-4 form-group group">', 'before'=> '</div>'],
            ['name' => 'fontSize', 'type' => 'tab', 'label' => 'Font size tiêu đề', 'value' => 25, 'options' => ['14' => '14', '15' => '15', '16' => '16', '17' => '17', '18' => '18', '20' => '20', '25' => '25', '30' => '30', '35' => '35', '40' => '40', '45' => '45']],
...
add_filter('theme_widget_heading', 'ThemeHeadingStyle1::register');
add_filter('theme_sidebar_heading', 'ThemeHeadingStyle1::register');
