<?php
Class ThemeHeadingStyle6 {
    static public function register($heading) {
        $heading['heading-style-6'] = ['label' => 'Heading Style 6', 'class' => 'ThemeHeadingStyle6'];
        return $heading;
    }
    static public function html($name) {
        ?><div class="header-title header-title-style-6"><p class="header"><?= $name;?></p></div><?php
    }
    static public function css($options, $id = '') {
        ...
        ?>
        <style>
            body <?php echo $id;?> .header-title.header-title-style-6 {
                text-align: left; margin: <?php echo $marginTop;?>px 0 <?php echo $marginBottom;?>px 0;
            }
            body <?php echo $id;?> .header-title.header-title-style-6 .header {
            ...
            body <?php echo $id;?> .header-title.header-title-style-6 .header:before {
                content: "";
                display: inline-block;
                width: 70px;
                position: absolute;
            ...
            body <?php echo $id;?> .header-title.header-title-style-6 .header:after {
                content: "\f005";
    ...
    static public function form() {
        ...
        $Form = [
            ['name' => 'bgColor1', 'type' => 'color', 'label' => 'Màu nền 1', 'after' => '<div class="col-md-4 form-group group">', 'before'=> '</div>'],
            ['name' => 'bgColor2', 'type' => 'color', 'label' => 'Màu nền 2', 'after' => '<div class="col-md-4 form-group group">', 'before'=> '</div>'],
...
add_filter('theme_widget_heading', 'ThemeHeadingStyle6::register');
add_filter('theme_sidebar_heading', 'ThemeHeadingStyle6::register');