...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle3_5::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle3_5::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle3_5::script');
}
else {
    add_action('init', 'ThemeHeaderStyle3_5::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle3_5::options', 20);
}