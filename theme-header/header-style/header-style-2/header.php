...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle2::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle2::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle2::script');
}
else {
    add_action('init', 'ThemeHeaderStyle2::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle2::options', 20);
}