<?php
Class ThemeHeaderStyle4_1 {

    public static $path = 'theme-header/header-style/header-style-4.1/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle4_1::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle4_1::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle4_1::script');
}
else {
    add_action('init', 'ThemeHeaderStyle4_1::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle4_1::options', 20);
}