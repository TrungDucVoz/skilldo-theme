<?php
Class ThemeHeaderStyle3_1 {

    public static $path = 'theme-header/header-style/header-style-3.1/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle3_1::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle3_1::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle3_1::script');
}
else {
    add_action('init', 'ThemeHeaderStyle3_1::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle3_1::options', 20);
}