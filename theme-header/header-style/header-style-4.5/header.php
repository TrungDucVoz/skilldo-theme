<?php
Class ThemeHeaderStyle4_5 {

    public static $path = 'theme-header/header-style/header-style-4.5/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle4_5::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle4_5::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle4_5::script');
}
else {
    add_action('init', 'ThemeHeaderStyle4_5::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle4_5::options', 20);
}