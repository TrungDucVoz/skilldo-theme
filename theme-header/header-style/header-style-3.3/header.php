<?php
Class ThemeHeaderStyle3_3 {

    public static $path = 'theme-header/header-style/header-style-3.3/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle3_3::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle3_3::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle3_3::script');
}
else {
    add_action('init', 'ThemeHeaderStyle3_3::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle3_3::options', 20);
}