...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle1_6::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle1_6::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle1_6::script');
}
else {
    add_action('init', 'ThemeHeaderStyle1_6::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle1_6::options', 20);
}