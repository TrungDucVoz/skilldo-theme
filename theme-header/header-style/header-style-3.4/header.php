<?php
Class ThemeHeaderStyle3_4 {

    public static $path = 'theme-header/header-style/header-style-3.4/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle3_4::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle3_4::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle3_4::script');
}
else {
    add_action('init', 'ThemeHeaderStyle3_4::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle3_4::options', 20);
}