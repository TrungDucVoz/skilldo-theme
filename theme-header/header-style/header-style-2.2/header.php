<?php
Class ThemeHeaderStyle2_2 {

    public static $path = 'theme-header/header-style/header-style-2.2/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle2_2::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle2_2::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle2_2::script');
}
else {
    add_action('init', 'ThemeHeaderStyle2_2::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle2_2::options', 20);
}