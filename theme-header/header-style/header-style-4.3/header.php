<?php
Class ThemeHeaderStyle4_3 {

    public static $path = 'theme-header/header-style/header-style-4.3/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle4_3::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle4_3::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle4_3::script');
}
else {
    add_action('init', 'ThemeHeaderStyle4_3::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle4_3::options', 20);
}