<?php
Class ThemeHeaderStyle4 {

    public static $path = 'theme-header/header-style/header-style-4/';
...
if(!Admin::is()) {
    add_action('cle_header_desktop', 'ThemeHeaderStyle4::render');
    add_action('theme_custom_css_no_tag', 'ThemeHeaderStyle4::css');
    add_action('theme_custom_script_no_tag', 'ThemeHeaderStyle4::script');
}
else {
    add_action('init', 'ThemeHeaderStyle4::navigation');
    add_action('theme_option_setup', 'ThemeHeaderStyle4::options', 20);
}