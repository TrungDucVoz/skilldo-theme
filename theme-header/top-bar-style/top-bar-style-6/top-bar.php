...
if(!Admin::is()) {
    add_action('cle_header_top_bar', 'ThemeTopBarStyle6::render');
    add_action('theme_custom_css_no_tag', 'ThemeTopBarStyle6::css');
}
else {
    add_action('theme_option_setup', 'ThemeTopBarStyle6::options', 22);
}
